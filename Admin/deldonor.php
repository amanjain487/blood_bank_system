...
<div class="nav_bg" >
	<div class="wrap">
		<ul class="nav" >
			&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li class="active"><p style="font-size:18px;font-weight: bold;"><a href="deldonor.php">Delete Donor</a></li>	
...
{
	$cn=makeconnection();
	$s="delete from registereddonors where donorid='"  . $_POST["s2"] ."'";
	mysqli_query($cn,$s);
	mysqli_close($cn);
...
<form method="post">
	<table border="0" align="center" width="400" height="300px" class="shaddoww">
		<tr><td colspan="2" align="center" class="toptd" style="color:#b30000 ;font-size:35px;font-family:Arial Black, Gadget, sans-serif">DELETE DONOR</td></tr>
		<tr><td colspan="2">&nbsp;</td></tr>
		<tr><td class="lefttd" style="font-size:20px;" >Select Donor Name:</td><td><select name="s2" required><option value="">Select</option>
