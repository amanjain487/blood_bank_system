...
<div class="nav_bg">
	<div class="wrap">
		<ul class="nav">
			<li class="active" style="font-size:18px;"><a href="../index.php">Preview Website</a></li>	
        	</ul>
	</div>
</div>  
...
<div style="height:400px;">
		...
		<table cellpadding="0" cellspacing="0" width="600px" height="300px" class="tableborder" style="margin:auto; margin-top:100px;" >
			...
			<tr><td class="lefttd">Super Name:&nbsp&nbsp&nbsp&nbsp</td><td><input type="text" name="t1" /></td></tr>
			<tr><td class="lefttd">Password:</td><td><input type="password"name="t2" /></td></tr>
			<tr><td>&nbsp;</td><td><input type="submit" value="Get Power" name="sbmt" style="border:0px; background:linear-gradient(#900,#D50000); width:100px; height:30px; border-radius:10px 1px 10px 1px; box-shadow:1px 1px 5px black; color:white; font-weight:bold; font-size:14px; text-shadow:1px 1px 6px black; "></td></tr>
			<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
		</table>
		</td></tr></table>
	</form>
...
if(isset($_POST["sbmt"])) 
{
	...
	$cn=makeconnection();			
			...
			$s="select * from superadmin where username='" . $_POST["t1"] . "' and pwd='" .$_POST["t2"] . "'";
