	...
	<div class="wrap">
		<ul class="nav" >
			...
			&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li><p style="font-size:18px;font-weight: bold;"><a href="addcamp.php">Add Camp</a></li> 
           		&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li class="active"><p style="font-size:18px;font-weight: bold;"><a href="deletecamp.php">Delete Camp</a></li>
...
{
	$cn=makeconnection();
	$s="delete from camp where campid='"  . $_POST["s1"] ."'";
	mysqli_query($cn,$s);
	mysqli_close($cn);
...
<form method="post">
	<table border="0" align="center" width="400" height="300px" class="shaddoww">
		<tr><td colspan="2" align="center" class="toptd" style="color:#b30000 ;font-size:35px;font-family:Arial Black, Gadget, sans-serif">Delete Camp </td></tr>
		<tr><td colspan="2">&nbsp;</td></tr>
		<tr><td class="lefttd" style="font-size:20px;">Select Camp: </td><td><select name="s1" required><option value="">Select</option>
...
<?php
	...
	{
		echo "<option value=$data[0]>$data[1],$data[3]</option>";
	}
	mysqli_close($cn);
...
?>
		...
		<tr><td>&nbsp;</td><td><input type="submit" value="Delete Camp" name="sbmt" style="border:0px; background:linear-gradient(#900,#D50000); width:100px; height:30px; border-radius:10px 1px 10px 1px; box-shadow:1px 1px 5px black; color:white; font-weight:bold; font-size:14px; text-shadow:1px 1px 6px black; "></td></tr>
	</table>
</form>
</center>
